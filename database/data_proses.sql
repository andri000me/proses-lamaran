...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 27 Agu 2020 pada 07.11
...
CREATE TABLE `data_proses` (
  ...
  `status_kepastian` enum('Menunggu','Diterima','Ditolak','Tidak Ada Respon') NOT NULL
...
--
ALTER TABLE `data_proses`
  MODIFY `id_data_proses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
COMMIT;
